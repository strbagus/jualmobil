...
$sqlmobil = "SELECT * FROM tb_mobil JOIN tb_merk 
            ON 
            tb_mobil.mobil_merk = tb_merk.merk_id
            WHERE 
            mobil_id='$id'";
        ...
        <div class="row">
            ...
            <form action="" method="post">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="form-group">
                            ...
                            <select name="merk" required="required" class="form-control">
                                <option selected value="<?= $dmobil['mobil_merk'] ?>" ><?= $dmobil['merk_nama'] ?></option>
                                <?php
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="transmisi" required="required">
                                ...
                                <?php
                                    if($dmobil['merk_nama'] == "Manual"){
                                        echo '<option value="Manual">Manual</option>';
                                    }else{
                                        echo '<option value="Matic">Matic</option>';
                                    }
                                ?>
                ...
                <div class="d-flex justify-content-center mt-5">
                    <input type="submit" value="Simpan Perubahan" name="tambahMobil" class="btn btn-primary">
                </div>
